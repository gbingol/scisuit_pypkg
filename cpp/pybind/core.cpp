...
namespace
{
	...
	bool AssignComplexValue(PyObject* Obj, std::complex<double>* CompNum, std::string& ErrMsg)
	{
...
PyObject* c_root_bisect(PyObject* FuncObj, double a, double b, double tol, int maxiter, const char* method, bool modified)
{
...
PyObject* c_root_brentq(PyObject* FuncObj, double a, double b, double tol, int maxiter)
{
	ASSERT_CALLABLE_RET(FuncObj, "First parameter must be callable.");
	auto func = Make1DFunction(FuncObj);
...
PyObject* c_root_muller(PyObject* FuncObj, PyObject* X0Obj, PyObject* hObj, PyObject* X1Obj, PyObject* X2Obj, double tol, int maxiter)
{
...
PyObject* c_root_newton(PyObject* FuncObj, double X0, PyObject* X1, PyObject* FPrimeObj, double tol, int maxiter)
{
...
PyObject* c_root_ridder(PyObject* FuncObj, double a, double b, double tol, int maxiter)
{
...
PyObject* c_fit_expfit(PyObject* X, PyObject* Y, PyObject* InterceptObj)
{
	try
	{
...
PyObject* c_fit_lagrange(PyObject* X, PyObject* Y, double Value)
{
	try
	{
		auto x = Iterable_As1DVector(X);
...
PyObject* c_fit_logfit(PyObject* X, PyObject* Y)
{
	try
	{
		auto x = Iterable_As1DVector(X);
...
PyObject* c_fit_logistfit(PyObject* X, PyObject* Y, PyObject* LimitObj)
{
	try
	{
		auto x = Iterable_As1DVector(X);
...
PyObject* c_fit_powfit(PyObject* X, PyObject* Y)
{
	try
	{
		auto x = Iterable_As1DVector(X);
...
PyObject* c_fit_spline(PyObject* X, PyObject* Y)
{
	try
	{
		auto x = Iterable_As1DVector(X);
