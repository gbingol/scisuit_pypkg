...
coreDLL.c_stat_dpareto.restype=_ct.py_object
coreDLL.c_stat_ppareto.argtypes = [_ct.py_object, _ct.c_double, _ct.c_double]
coreDLL.c_stat_ppareto.restype=_ct.py_object
coreDLL.c_stat_qpareto.argtypes = [_ct.py_object, _ct.c_double, _ct.c_double]
coreDLL.c_stat_qpareto.restype=_ct.py_object
